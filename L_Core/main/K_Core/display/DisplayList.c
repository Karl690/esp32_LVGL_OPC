...
DisplayVariableInfo LcdVarsTable[] = {
	...
	{ &ADC_Channel[0].convAvg, "ADC CH0", FUNC_FLOAT, COLOR_WHITE, COLOR_RED, 0, NULL },
	{ &ADC_Channel[0].adcAvg, "ADC CH0-Raw", FUNC_INT16, COLOR_WHITE, COLOR_RED, 0, NULL },
	{ &ADC_Channel[1].convAvg, "ADC CH1", FUNC_FLOAT, COLOR_WHITE, COLOR_RED, 0, NULL },
	{ &ADC_Channel[1].adcAvg, "ADC CH1-Raw", FUNC_INT16, COLOR_WHITE, COLOR_RED, 0, NULL },
	{ &ADC_Channel[2].convAvg, "ADC CH2", FUNC_FLOAT, COLOR_WHITE, COLOR_RED, 0, NULL },
	{ &ADC_Channel[2].adcAvg, "ADC CH2-Raw", FUNC_INT16, COLOR_WHITE, COLOR_RED, 0, NULL },
	{ &ADC_Channel[3].convAvg, "ADC CH3", FUNC_FLOAT, COLOR_WHITE, COLOR_RED, 0, NULL },
	{ &ADC_Channel[3].adcAvg, "ADC CH3-Raw", FUNC_INT16, COLOR_WHITE, COLOR_RED, 0, NULL },
	{ &ADC_Channel[4].convAvg, "ADC CH4", FUNC_FLOAT, COLOR_WHITE, COLOR_RED, 0, NULL },
	{ &ADC_Channel[4].adcAvg, "ADC CH4-Raw", FUNC_INT16, COLOR_WHITE, COLOR_RED, 0, NULL },
	{ 0 },
};
