...
DisplayVariableInfo LcdVarsTable[] = {
	{ (void*)SYSTEMINFO, "SystemInfo", FUNC_ASCII, COLOR_WHITE, COLOR_RED, 0, 0, NULL },
	{ (void*)SYSTEMVERSION, "Version", FUNC_ASCII, COLOR_WHITE, COLOR_RED, 0, 0, NULL },
	{ (void*)WIFI_SSID, "WIFI SSID", FUNC_ASCII, COLOR_WHITE, COLOR_RED, 0, 0, NULL },
	{ ipAddress, "WIFI IP", FUNC_ASCII, COLOR_WHITE, COLOR_RED, 0, 0, NULL },
	{ &wifi_is_connected, "WIFI Status", FUNC_BOOLEAN, COLOR_WHITE, COLOR_RED, 0, 0, NULL },
