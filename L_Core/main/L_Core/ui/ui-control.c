...
void ui_control_screen_init()
{
	...
	obj = ui_create_button(ui_control_screen, "+", 100, 40, 5, 0x0060B8, &lv_font_montserrat_30, ui_control_button_handler, (void*)CONTROLS_FAN_PLUS);
	...
	obj = ui_create_button(ui_control_screen, "-", 100, 40, 5, 0x0060B8, &lv_font_montserrat_30, ui_control_button_handler, (void*)CONTROLS_FAN_MINUS);	
	lv_obj_align(obj, LV_ALIGN_CENTER, -160, 130);
	
	
	obj = ui_create_button(ui_control_screen, "+", 100, 40, 5, 0xB82C00, &lv_font_montserrat_30, ui_control_button_handler, (void*)CONTROLS_HEAT_MINUS);
	...
	obj = ui_create_button(ui_control_screen, "+", 100, 40, 5, 0x7DB800, &lv_font_montserrat_30, ui_control_button_handler, (void*)CONTROLS_HEAT_PLUS);
	lv_obj_align(obj, LV_ALIGN_CENTER, 160, -100);
	...
	lv_obj_align(obj, LV_ALIGN_CENTER, 160, 90);
	obj = ui_create_button(ui_control_screen, "-", 100, 40, 5, 0x7DB800, &lv_font_montserrat_30, ui_control_button_handler, (void*)CONTROLS_MTR_MINUS);	
	lv_obj_align(obj, LV_ALIGN_CENTER, 160, 130);
}